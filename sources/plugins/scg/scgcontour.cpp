...
SCgContour::SCgContour() : mColorBack(QColor(250, 250, 250, 164)) {
...
QPainterPath SCgContour::shape() const { return mShape; }
...
void SCgContour::paint(QPainter *painter,
...
void SCgContour::setColorBack(const QColor &color) { mColorBack = color; }

QColor SCgContour::colorBack() const { return mColorBack; }
...
void SCgContour::positionChanged() { updateShape(); }

void SCgContour::minimize() { setPoints(minimizedPoints()); }
...
void SCgContour::objectDelete(SCgObject *object) { Q_UNUSED(object); }
