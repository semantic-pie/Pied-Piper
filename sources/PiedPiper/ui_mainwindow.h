...
public:
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        shortcuts << QKeySequence::Quit << QKeySequence::Close;
        actionExit ->setShortcuts(shortcuts);
...
#endif // QT_CONFIG(shortcut)
        actionClose_All->setText(QCoreApplication::translate("MainWindow", "Close", nullptr));
#if QT_CONFIG(shortcut)
